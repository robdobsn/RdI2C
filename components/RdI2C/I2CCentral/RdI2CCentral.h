...
// #define DEBUG_RICI2C_CENTRAL_ISR
// #define DEBUG_RICI2C_CENTRAL_ISR_ALL_SOURCES
// #define DEBUG_RICI2C_CENTRAL_ISR_ON_FAIL

class RdI2CCentral : public RdI2CCentralIF
{
public:
    RdI2CCentral();
    virtual ~RdI2CCentral();
...
private:
...
#ifdef DEBUG_RICI2C_CENTRAL_ISR_ALL_SOURCES
    ...
    // Debug I2C ISR
#if defined(DEBUG_RICI2C_CENTRAL_ISR) || defined(DEBUG_RICI2C_CENTRAL_ISR_ON_FAIL)
    ...
    public:
        ...
        static const uint32_t DEBUG_RICI2C_CENTRAL_ISR_MAX = 100;
        DebugI2CISRElem _i2cISRDebugElems[DEBUG_RICI2C_CENTRAL_ISR_MAX];
        uint32_t _i2cISRDebugCount;
        void IRAM_ATTR debugISRAdd(const char* msg, uint32_t intStatus, 
                        uint32_t mainStatus, uint32_t txFifoStatus)
        {
            if (_i2cISRDebugCount >= DEBUG_RICI2C_CENTRAL_ISR_MAX)
                return;
